...
- (NSMutableArray *)imageContainerArr {
    if (!_imageContainerArr) {
        _imageContainerArr = [NSMutableArray array];
    }
...
- (void)photoClick:(UITapGestureRecognizer *)recognizer
{
    ...
    //代理操作
    if ([self.delegate respondsToSelector:@selector(selfView:imageForIndex:currentImageView:)]) {
        [self.delegate selfView:self imageForIndex:currentIndex currentImageView:tempView];
    }
}
