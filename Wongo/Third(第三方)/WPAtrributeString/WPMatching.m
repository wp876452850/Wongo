...
@implementation WPMatching
//匹配字符里的url 返回range数组
+(NSArray*)urlRangeArrWithString:(NSString*)string
{
    NSString *regulaStr = @"((http[s]{0,1}|ftp)://[a-zA-Z0-9\\.\\-]+\\.([a-zA-Z]{2,4})(:\\d+)?(/[a-zA-Z0-9\\.\\-~!@#$%^&*+?:_/=<>]*)?)|(www.[a-zA-Z0-9\\.\\-]+\\.([a-zA-Z]{2,4})(:\\d+)?(/[a-zA-Z0-9\\.\\-~!@#$%^&*+?:_/=<>]*)?)";
    
    NSArray *rangeArr = [WPMatching rangeArrWithString:string andMatchingString:regulaStr];
    return rangeArr;
}
...
+(NSArray*)urlArrWithString:(NSString*)string
{
    ...
    NSArray *urlStr_Arr = [WPMatching subRangeStringWithString:string andRangeArr:rangeArr];
...
{
    NSArray *phoneRange_Arr = [WPMatching phoneNumRangeArrWithString:string];
    NSArray *phoneNum_Arr = [WPMatching subRangeStringWithString:string andRangeArr:phoneRange_Arr];
    return phoneNum_Arr;
}
...
+(NSArray*)phoneNumRangeArrWithString:(NSString*)string
{
    ...
    NSArray *phoneNumberRange_Arr = [WPMatching rangeArrWithString:string andMatchingString:regulaStr];
...
{
    NSArray *emailRange_Arr = [WPMatching emailRangeArrWithString:string];
    NSArray *email_Arr = [WPMatching subRangeStringWithString:string andRangeArr:emailRange_Arr];
    return email_Arr;
}
...
+(NSArray*)emailRangeArrWithString:(NSString*)string
{
    ...
    NSArray *emailRange_Arr = [WPMatching rangeArrWithString:string andMatchingString:regulaStr];
