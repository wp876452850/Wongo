...
//        return [NSString stringWithFormat:@"%@天 %@小时 %@分 %@秒", dayStr,hoursStr, minutesStr,secondsStr];
        return [NSString stringWithFormat:@"%zdd:%zdh:%zdm:%zds", days,hours,minutes,seconds];
    }
//    return [NSString stringWithFormat:@"%@小时 %@分 %@秒",hoursStr , minutesStr,secondsStr];
    if (hours>0) {
        return [NSString stringWithFormat:@"%zdh:%zdm:%zds",hours , minutes,seconds];
    }
    return [NSString stringWithFormat:@"%zdm:%zds", minutes,seconds];
}
