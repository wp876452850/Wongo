...
-(UIImageView *)varietiesImageView{
    if (!_varietiesImageView) {
        _varietiesImageView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, self.width, _varietiesTitleLabel.height>0?self.height-_varietiesTitleLabel.height - 10:self.height - 20)];
        ...
        _varietiesImageView.contentMode = UIViewContentModeScaleAspectFit;
