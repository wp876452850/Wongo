//
//  WPNewPushImagesCollectionViewCell.m
//  Wongo
//
...
@interface WPNewPushImagesCollectionViewCell ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,SDPhotoBrowserDelegate>
{
    WPNewPushImageBlock _backImagesBlock;
...
@end
@implementation WPNewPushImagesCollectionViewCell
